...
int main (void){
    ...
    printf("Digite quantas horas você fez atividades físicas: ");
    scanf("%d", &horas);
    ...
    if (horas<0){
        printf("Você digitou as horas erradamente");
    } else {
        if (horas<10){
            pontos = horas *2;
    ...
    printf("Você obteve um total de pontos de %d, obtendo um valor de R$ %.2f", pontos, dinheiro);
